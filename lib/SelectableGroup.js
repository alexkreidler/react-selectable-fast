...
var SelectableGroup = (function (_super) {
    ...
    SelectableGroup.prototype.onUnselectedFinish = function () {
        if (!this.props.onUnselectedFinish)
            return;
        var a = this.registry;
        var b = this.selectedItems;
        var unselected = new Set(__spread(a).filter(function (x) { return !b.has(x); }));
        this.props.onUnselectedFinish(__spread(unselected));
    };
